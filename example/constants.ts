  ...
  },
  {
    ...
    filters: [
      ...
      },
      {
        id: "outline",
        name: "Outline",
        icon: "square.on.square.dashed" as SFSymbol,
        property: "width",
        min: 0,
        max: 100,
        default: 30,
        converter: (v: number) => v / 10,
        secondary: {
          property: "colorAlpha",
          min: 0,
          max: 100,
        ...
        presets: [
          { name: "Red", colorRed: 1, colorGreen: 0, colorBlue: 0 },
          { name: "Green", colorRed: 0, colorGreen: 1, colorBlue: 0 },
          { name: "Blue", colorRed: 0, colorGreen: 0, colorBlue: 1 },
          { name: "Yellow", colorRed: 1, colorGreen: 1, colorBlue: 0 },
          { name: "Magenta", colorRed: 1, colorGreen: 0, colorBlue: 1 },
          { name: "Cyan", colorRed: 0, colorGreen: 1, colorBlue: 1 },
          { name: "White", colorRed: 1, colorGreen: 1, colorBlue: 1 },
          { name: "Black", colorRed: 0, colorGreen: 0, colorBlue: 0 },
        ],
      },
      {
        id: "shine",
        name: "Shine",
        icon: "sparkle" as SFSymbol,
        property: "width",
        min: 0,
        max: 100,
        default: 30,
        ...
        presets: [
          { name: "White", colorRed: 1, colorGreen: 1, colorBlue: 1 },
          { name: "Gold", colorRed: 1, colorGreen: 0.84, colorBlue: 0 },
          { name: "Red", colorRed: 1, colorGreen: 0, colorBlue: 0 },
          { name: "Blue", colorRed: 0, colorGreen: 0.5, colorBlue: 1 },
          { name: "Green", colorRed: 0, colorGreen: 1, colorBlue: 0 },
          { name: "Magenta", colorRed: 1, colorGreen: 0, colorBlue: 1 },
          { name: "Cyan", colorRed: 0, colorGreen: 1, colorBlue: 1 },
        ],
